				...
				<ul class="app_list">
					<li class="clear"><label for="title_lbl"
						...
						<div class="app_content">
							<input type="text" class="w100p" id="title_lbl"
								placeholder="제목을 입력해주세요" />
						</div></li>
					<li class="clear"><label for="content_lbl" class="tit_lbl">내용</label>
						<div class="app_content">
...
전화 상담 희망시 기재 부탁드립니다."></textarea>
				...
				<p class="btn_line">
					<a href="notice_list.html" class="btn_baseColor">등록</a> <a
						href="notice_list.html" class="btn_baseColor">목록</a>
				</p>
			</fieldset>
		</form>
		<!-- //appForm -->
